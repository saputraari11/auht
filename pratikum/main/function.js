...
const registrasi_pelanggan = (link, valid) => {
    return app.post(link, valid(), (req, res) => {
        let data = {
...
const registrasi_mobil = (link, valid) => {
    return app.post(link, valid(), upload.single("image"), (req, res) => {
        if (!req.file) {
            res.json({
...
const getInfo_pelanggan = (link, valid) => {
    return app.get(link, valid(), (req, res) => {
        let data = null
        let sql = null
...
const edit_pelanggan = (link, valid) => {
    return app.put(link, valid(), (req, res) => {
        let data = [{
            nama_pelanggan: req.body.nama_pelanggan,
            alamat_pelanggan: req.body.alamat_pelanggan,
            kontak: req.body.kontak
...
const edit_mobil = (link, valid) => {
    return app.put(link, valid(), upload.single("image"), (req, res) => {
        let sql = null
        let data = null
...
const delete_pelanggan = (link, valid) => {
    return app.delete(link, valid(), (req, res) => {
        let data = {
...
const input_kembali = (link, valid) => {
    return app.put(link, valid(), (req, res) => {
...
const update_kembali = (link, valid) => {
    return app.put(link, valid(), (req, res) => {
...
const hapus_penyewaan = (link, valid) => {
    return app.delete(link, valid(), (req, res) => {
        let sql = null
